...
The RC400L's `atfwd_daemon` (164 KB) handles 44 AT commands directly, covering GPS, audio, cellular, hardware I/O, and security. See [atfwd_daemon Reversal](./atfwd_reversal.md) for the full breakdown.
